...
/* package lucid-from-html-app-0.1.0.0 */
#ifndef VERSION_lucid_from_html_app
#define VERSION_lucid_from_html_app "0.1.0.0"
#endif /* VERSION_lucid_from_html_app */
#ifndef MIN_VERSION_lucid_from_html_app
#define MIN_VERSION_lucid_from_html_app(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_lucid_from_html_app */
...
#define CURRENT_PACKAGE_KEY "lucid-from-html-app-0.1.0.0-inplace"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "lucid-from-html-app-0.1.0.0-inplace"
